<template>
  <div ref="drawingArea" class="drawing-area" @click="handleClick">
    <svg id="svg-container" width="500" height="500">
      <line v-for="(lin,l) in lineList" :key="l" :x1="lin.x" :y1="lin.y" :x2="lin.x1" :y2="lin.y1" stroke="black"
            stroke-width="2">
...
const handleClick = (event: MouseEvent) => {
  const position = {x: event.clientX - drawingArea.value!.offsetLeft, y: event.clientY - drawingArea.value!.offsetTop}
  if (!showLine.value) {
